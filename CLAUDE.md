...
**Metadata:** Version 1.0.2, Author: hügelton instrument (Leo Kuroshita), Kobe, Japan
...
- **DrumPattern**: Drum pattern editor with velocity and chance controls
- **SynthEdit**: 3-voice synthesizer editor (oscillator, filter, amp, LFO, envelope)
